...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoicm9ic29ucmMiLCJhIjoiY2syczFmd2hnMHZ1ZDNjbjg3ejJmdGdubSJ9.R9lYPi7o4FjZgNrrNcZwEQ';
...
/* eslint-disable */
var stripe = Stripe('pk_test_nC2R2w7duXcvX3BQMoD5xaWz00NMoPJOWW');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap((0, _axios.default)("http://127.0.0.1:8000/api/v1/bookings/checkout-session/".concat(tourId)));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42843" + '/');
